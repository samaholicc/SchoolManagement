    ...
    public partial class StudentsInClassSection : KryptonForm
    {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = "SELECT s.Student_id AS `Student ID`, s.Full_name AS `Name`, " +
                                   ...
                                   "_Lingobit_JOIN student_classes sc ON s.student_id = sc.student_id " +
        ...
        private void pbDelete_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "_Lingobit_DELETE FROM student_classes WHERE student_id = @StudentID AND class_id = @ClassID";
