    ...
    public partial class StudentGrade : KryptonForm
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conn.Open();
                    string query = "_Lingobit_SELECT A.CLASS_ID AS `Class section ID`, D.SUB_ID AS `Subject ID`, D.SUB_NAME AS `Subject name`, D.credits AS `Subject credits`, A.Mid_Term AS `Mid term`, A.Final_Term AS `Final term`, A.Average AS `Average` " +
                                   "FROM results A " +
                                   "JOIN class B ON A.CLASS_ID = B.CLASS_ID " +
                                   "JOIN Subject D ON B.SUB_ID = D.SUB_ID " +
